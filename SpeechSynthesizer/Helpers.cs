...
namespace SpeechSynthesizer
{
	public static class Helpers
	{
		...
		public static bool IsVowel(Utf32Char? c) => c is not null && Vowels.Contains(c);

		public static bool IsAlphabet(Utf32Char? c) => c is not null && Alphabet.Contains(c);

		public static bool IsConsonant(Utf32Char? c) => c is not null && Consonants.Contains(c);
