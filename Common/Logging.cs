...
namespace PuroBot.Common
{
    public static class Logging
    {
        static Logging()
        {
            string configurationPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Config", "log4net.config");
            XmlConfigurator.Configure(new FileInfo(configurationPath));
        }

        private static readonly ILog Logger = LogManager.GetLogger(MethodBase.GetCurrentMethod()?.DeclaringType);

        /// <summary> Log a <see cref="Level.Debug" /> message to the default log output </summary>
        ...
        /// <summary> Log a <see cref="Level.Error" /> message to the default log output </summary>
        /// <param name="msg"> the message to be logged </param>
        /// <param name="exception"> the <see cref="Exception" /> that has occured (optional) </param>
        /// <param name="source"> where the <paramref name="msg" /> originated (optional) </param>
        ...
        /// <summary> Log a <see cref="Level.Fatal" /> message to the default log output </summary>
        /// <param name="msg"> the message to be logged </param>
        /// <param name="exception"> the <see cref="Exception" /> that has occured (optional) </param>
        /// <param name="source"> where the <paramref name="msg" /> originated (optional) </param>
        ...
        /// <summary> Log a <see cref="Level.Info" /> message to the default log output </summary>
        /// <param name="msg"> the message to be logged </param>
        /// <param name="exception"> the <see cref="Exception" /> that has occured (optional) </param>
        /// <param name="source"> where the <paramref name="msg" /> originated (optional) </param>
        ...
        /// <summary> Log a <see cref="Level.Warn" /> message to the default log output </summary>
        /// <param name="msg"> the message to be logged </param>
        /// <param name="exception"> the <see cref="Exception" /> that has occured (optional) </param>
        /// <param name="source"> where the <paramref name="msg" /> originated (optional) </param>
